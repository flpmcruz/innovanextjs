      ...
      <section className=" shadow-2xl bg-white pt-32">
        <div className="carousel-inner relative overflow-hidden w-full md:w-2/4 mx-auto">
          ...
          <div className="carousel-item absolute opacity-0 h-96">
            <img loading="lazy" src="img/slide1.jpg " alt="image house 1" className="block h-full w-full object-cover object-center" />
          </div>
          ...
          <input className="carousel-open" type="radio" id="carousel-2" name="carousel" aria-hidden="true" checked hidden />
          <div className="carousel-item absolute opacity-0 h-96">
            <img loading="lazy" src="img/slide2.jpg " alt="image house 2" className="block h-full w-full object-cover object-center" />
          </div>
          ...
          <input className="carousel-open" type="radio" id="carousel-3" name="carousel" aria-hidden="true" checked hidden />
          <div className="carousel-item absolute opacity-0 h-96">
            <img loading="lazy" src="img/slide3.jpg " alt="image house 3" className="block h-full w-full object-cover object-center" />
          </div>
      ...
      <section className="bg-white dark:bg-gray-900 pt-10">
        <div className="container px-6 py-10 mx-auto">
          ...
          <p className="mt-4 text-center text-gray-500 dark:text-gray-300 text-2xl">
            Custom designs htmlFor all needs. We are specialists in urban areas and beach areas!
          </p>
